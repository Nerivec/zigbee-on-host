    ...
    return [
        {
            ...
            autoCommissioning: !!((fcf & 64 /* ZigbeeNWKGPConsts.FCF_AUTO_COMMISSIONING */) >> 6),
            nwkFrameControlExtension: !!((fcf & 128 /* ZigbeeNWKGPConsts.FCF_CONTROL_EXTENSION */) >> 7),
        },
        offset,
    ];
}
    ...
    return [
        {
            ...
            securityKey: !!((fcf & 32 /* ZigbeeNWKGPConsts.FCF_EXT_SECURITY_KEY */) >> 5),
            rxAfterTx: !!((fcf & 64 /* ZigbeeNWKGPConsts.FCF_EXT_RX_AFTER_TX */) >> 6),
...
function makeGPNonce(header, macSource64) {
    const nonce = Buffer.allocUnsafe(13 /* ZigbeeConsts.SEC_NONCE_LEN */);
    let offset = 0;
...
function encodeZigbeeNWKGPFrame(header, payload, decryptKey, macSource64) {
    let offset = 0;
    const data = Buffer.allocUnsafe(116 /* ZigbeeNWKGPConsts.FRAME_MAX_SIZE */);
