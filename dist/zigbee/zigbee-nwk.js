    ...
    return [
        {
            ...
            multicast: !!((fcf & 256 /* ZigbeeNWKConsts.FCF_MULTICAST */) >> 8),
            security: !!((fcf & 512 /* ZigbeeNWKConsts.FCF_SECURITY */) >> 9),
            sourceRoute: !!((fcf & 1024 /* ZigbeeNWKConsts.FCF_SOURCE_ROUTE */) >> 10),
            extendedDestination: !!((fcf & 2048 /* ZigbeeNWKConsts.FCF_EXT_DEST */) >> 11),
            extendedSource: !!((fcf & 4096 /* ZigbeeNWKConsts.FCF_EXT_SOURCE */) >> 12),
            endDeviceInitiator: !!((fcf & 8192 /* ZigbeeNWKConsts.FCF_END_DEVICE_INITIATOR */) >> 13),
        },
        offset,
    ];
}
...
function encodeZigbeeNWKFrame(header, payload, securityHeader, encryptKey) {
    let offset = 0;
    const data = Buffer.allocUnsafe(116 /* ZigbeeNWKConsts.FRAME_MAX_SIZE */);
