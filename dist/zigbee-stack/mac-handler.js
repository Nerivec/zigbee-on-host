...
class MACHandler {
    ...
    async processAssocReq(data, offset, macHeader) {
        ...
        if (macHeader.source64 === undefined) {
            ...
            const [status, newAddress16] = await this.#context.associate(address16, macHeader.source64, address16 === undefined /* initial join if unknown device, else rejoin */, decodedCap, true /* neighbor */);
