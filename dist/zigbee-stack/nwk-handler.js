...
class NWKHandler {
    ...
    async sendRouteReq(manyToOne, destination16, destination64) {
        ...
        return await this.sendCommand(1 /* ZigbeeNWKCommandId.ROUTE_REQ */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, 65532 /* ZigbeeConsts.BCAST_DEFAULT */, // nwkDest16
        undefined, // nwkDest64
    ...
    async sendRouteReply(requestDest1stHop16, requestRadius, requestId, originator16, responder16, originator64, responder64) {
        ...
        return await this.sendCommand(2 /* ZigbeeNWKCommandId.ROUTE_REPLY */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
    ...
    async sendStatus(requestSource16, status, destination) {
        ...
        // TODO
        // const [tlvs, tlvsOutOffset] = encodeZigbeeNWKTLVs();
        return await this.sendCommand(3 /* ZigbeeNWKCommandId.NWK_STATUS */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
    ...
    async processLeave(data, offset, macHeader, nwkHeader) {
        const options = data.readUInt8(offset);
        offset += 1;
        const removeChildren = !!(options & 128 /* ZigbeeNWKConsts.CMD_LEAVE_OPTION_REMOVE_CHILDREN */);
        const request = !!(options & 64 /* ZigbeeNWKConsts.CMD_LEAVE_OPTION_REQUEST */);
        const rejoin = !!(options & 32 /* ZigbeeNWKConsts.CMD_LEAVE_OPTION_REJOIN */);
    ...
    async sendLeave(destination16, rejoin) {
        ...
        return await this.sendCommand(4 /* ZigbeeNWKCommandId.LEAVE */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
        destination16, // nwkDest16
    ...
    async sendRejoinResp(requestSource16, newAddress16, status) {
        ...
        return await this.sendCommand(7 /* ZigbeeNWKCommandId.REJOIN_RESP */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
        requestSource16, // nwkDest16
    ...
    processLinkStatus(data, offset, macHeader, nwkHeader) {
        ...
        const options = data.readUInt8(offset);
        offset += 1;
        const firstFrame = !!((options & 32 /* ZigbeeNWKConsts.CMD_LINK_OPTION_FIRST_FRAME */) >> 5);
        const lastFrame = !!((options & 64 /* ZigbeeNWKConsts.CMD_LINK_OPTION_LAST_FRAME */) >> 6);
    ...
    async sendLinkStatus(links) {
        ...
        for (let i = 0; i < frameCount; i++) {
            ...
            await this.sendCommand(8 /* ZigbeeNWKCommandId.LINK_STATUS */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, 65532 /* ZigbeeConsts.BCAST_DEFAULT */, // nwkDest16
            undefined, // nwkDest64
            1);
        }
    }
    ...
    async sendEdTimeoutResponse(requestDest16, requestedTimeout, statusOverride, parentInfoOverride) {
        ...
        return await this.sendCommand(12 /* ZigbeeNWKCommandId.ED_TIMEOUT_RESPONSE */, finalPayload, true, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
    ...
    async sendCommissioningResponse(requestSource16, newAddress16, status) {
        ...
        return await this.sendCommand(15 /* ZigbeeNWKCommandId.COMMISSIONING_RESPONSE */, finalPayload, false, 0 /* ZigbeeConsts.COORDINATOR_ADDRESS */, // nwkSource16
        requestSource16, // nwkDest16
        this.#context.address16ToAddress64.get(requestSource16), // nwkDest64
        exports.CONFIG_NWK_MAX_HOPS);
    }
