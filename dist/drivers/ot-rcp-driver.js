...
class OTRCPDriver {
    ...
    constructor(transport, callbacks, streamRawConfig, netParams, saveDir, emitMACFrames = false) {
    ...
    async onFrame(buffer) {
        const spinelFrame = (0, spinel_js_1.decodeSpinelFrame)(buffer);
    ...
    async start() {
        ...
        // flush
        this.transport.write(Buffer.from([126 /* HdlcReservedByte.FLAG */]));
        // Example output:
    ...
    async sendZDO(payload, nwkDest16, nwkDest64, clusterId) {
        ...
        clusterId, 0 /* ZigbeeConsts.ZDO_PROFILE_ID */, 0 /* ZigbeeConsts.ZDO_ENDPOINT */, 0 /* ZigbeeConsts.ZDO_ENDPOINT */, // sourceEndpoint
        undefined);
    ...
    async sendUnicast(payload, profileId, clusterId, dest16, dest64, destEp, sourceEp) {
        ...
        dest16, // nwkDest16
        dest64, 0 /* ZigbeeAPSDeliveryMode.UNICAST */, // apsDeliveryMode
        clusterId, // clusterId
        profileId, // profileId
        destEp, // destEndpoint
    ...
    async sendGroupcast(payload, profileId, clusterId, group, sourceEp) {
        return await this.apsHandler.sendData(payload, 0 /* ZigbeeNWKRouteDiscovery.SUPPRESS */, 65533 /* ZigbeeConsts.BCAST_RX_ON_WHEN_IDLE */, // nwkDest16
        undefined, 3 /* ZigbeeAPSDeliveryMode.GROUP */, // apsDeliveryMode
        clusterId, // clusterId
        profileId, // profileId
    ...
    async sendBroadcast(payload, profileId, clusterId, dest16, destEp, sourceEp) {
        ...
        return await this.apsHandler.sendData(payload, 0 /* ZigbeeNWKRouteDiscovery.SUPPRESS */, // nwkDiscoverRoute
        dest16, // nwkDest16
        undefined, 2 /* ZigbeeAPSDeliveryMode.BCAST */, // apsDeliveryMode
        clusterId, // clusterId
        profileId, // profileId
        destEp, // destEndpoint
        sourceEp, // sourceEndpoint
