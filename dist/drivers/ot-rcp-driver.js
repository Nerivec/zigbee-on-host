...
class OTRCPDriver {
    ...
    async onStreamRawFrame(payload, metadata) {
        ...
        try {
            ...
            /* @__INLINE__ */
            if (macHeader.destinationPANId !== 65535 /* ZigbeeMACConsts.BCAST_PAN */ && macHeader.destinationPANId !== this.context.netParams.panId) {
            ...
            if (macPayload.byteLength > 0) {
                ...
                if (protocolVersion === 3 /* ZigbeeNWKConsts.VERSION_GREEN_POWER */) {
                    if ((macFCF.destAddrMode === 2 /* MACFrameAddressMode.SHORT */ && macHeader.destination16 === 65535 /* ZigbeeMACConsts.BCAST_ADDR */) ||
                        ...
                        const nwkGPPayload = (0, zigbee_nwkgp_js_1.decodeZigbeeNWKGPPayload)(macPayload, nwkGPHOutOffset, this.context.netParams.networkKey, macHeader.source64, nwkGPFCF, nwkGPHeader);
                        // Delegate GP frame processing to NWK GP handler
                        this.nwkGPHandler.processFrame(nwkGPPayload, macHeader, nwkGPHeader, this.context.computeLQA(metadata?.rssi ?? this.context.rssiMin));
                    }
                    else {
                    ...
                    nwkHeader.source64 ?? this.context.address16ToAddress64.get(nwkHeader.source16), nwkFCF, nwkHeader);
                    if (nwkFCF.frameType === 0 /* ZigbeeNWKFrameType.DATA */) {
                        ...
                        /* nwkHeader.frameControl.extendedSource ? nwkHeader.source64 : this.context.address16ToAddress64.get(nwkHeader.source16!) */
                        nwkHeader.source64 ?? this.context.address16ToAddress64.get(nwkHeader.source16), apsFCF, apsHeader);
