...
export declare class OTRCPDriver {
    ...
    constructor(transport: TransportInterface, callbacks: StackCallbacks, streamRawConfig: StreamRawConfig, netParams: NetworkParameters, saveDir: string, emitMACFrames?: boolean);
