 ...
 * @returns
 */
export declare function estimateTLVStateSize(deviceCount: number): number;
/**
 ...
 */
export declare function serializeDeviceEntry(address64: bigint, address16: number, capabilities: number, authorized: boolean, neighbor: boolean, sourceRouteEntries?: SourceRouteTableEntry[]): Buffer;
export {};
