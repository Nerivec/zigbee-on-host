export const enum SpinelPropertyId {
    ...
    PHY_CHAN = 0x20 + 1,
    /** Format: `A(C)` */
    PHY_CHAN_SUPPORTED = 0x20 + 2,
    /** kHz Format: `L` */
    PHY_FREQ = 0x20 + 3,
    /** dBm Format: `c` */
    PHY_CCA_THRESHOLD = 0x20 + 4,
    /** Format: `c` */
    PHY_TX_POWER = 0x20 + 5,
    /** dBm Format: `c` */
    PHY_RSSI = 0x20 + 6,
    /** dBm Format: `c` */
    PHY_RX_SENSITIVITY = 0x20 + 7,
    /** Format: `b` */
    PHY_PCAP_ENABLED = 0x20 + 8,
    /** Format: `A(C)` */
    PHY_CHAN_PREFERRED = 0x20 + 9,
    /** dBm Format: `c` */
    PHY_FEM_LNA_GAIN = 0x20 + 10,
     ...
     * channel blocked.
     */
    JAM_DETECT_RSSI_THRESHOLD = 0x1200 + 2,
     ...
     */
    JAM_DETECT_HISTORY_BITMAP = 0x1200 + 5,
     ...
     * threshold.
     */
    CHANNEL_MONITOR_SAMPLE_INTERVAL = 0x1200 + 6,
     ...
     */
    CHANNEL_MONITOR_RSSI_THRESHOLD = 0x1200 + 7,
     ...
     * the sample window.
     */
    CHANNEL_MONITOR_SAMPLE_WINDOW = 0x1200 + 8,
     ...
     * was enabled).
     */
    CHANNEL_MONITOR_SAMPLE_COUNT = 0x1200 + 9,
     ...
     */
    CHANNEL_MONITOR_CHANNEL_OCCUPANCY = 0x1200 + 10,
     ...
     */
    MAC_RX_ON_WHEN_IDLE_MODE = 0x30 + 11,
     ...
     */
    MAC_ALLOWLIST = 0x1300 + 0,

    /// MAC Allowlist Enabled Flag
    /** Format: `b`
     * Required capability: `CAP_MAC_ALLOWLIST`
     */
    MAC_ALLOWLIST_ENABLED = 0x1300 + 1,
     ...
     */
    MAC_SRC_MATCH_ENABLED = 0x1300 + 3,

    /// MAC Source Match Short Address List
    /** Format: `A(S)`
     * Required Capability: SPINEL_CAP_MAC_RAW or SPINEL_CAP_CONFIG_RADIO
     */
    MAC_SRC_MATCH_SHORT_ADDRESSES = 0x1300 + 4,

    /// MAC Source Match Extended Address List
    /** Format: `A(E)`
     *  Required Capability: SPINEL_CAP_MAC_RAW or SPINEL_CAP_CONFIG_RADIO
     */
    MAC_SRC_MATCH_EXTENDED_ADDRESSES = 0x1300 + 5,
     ...
     *  `E`: EUI64 address of node
     */
    MAC_DENYLIST = 0x1300 + 6,

    /// MAC Denylist Enabled Flag
    /** Format: `b`
     *  Required capability: `CAP_MAC_ALLOWLIST`
     */
    MAC_DENYLIST_ENABLED = 0x1300 + 7,
     ...
     */
    MAC_MAX_RETRY_NUMBER_DIRECT = 0x1300 + 10,
     ...
     */
    MAC_MAX_RETRY_NUMBER_INDIRECT = 0x1300 + 11,
    ...
    /** Format `D` - Read-write
     */
    NET_NETWORK_KEY = 0x40 + 6,

    /// Thread Network Key Sequence Counter
    /** Format `L` - Read-write
     */
    NET_KEY_SEQUENCE_COUNTER = 0x40 + 7,
     ...
     */
    NET_REQUIRE_JOIN_EXISTING = 0x40 + 9,

    /// Thread Network Key Switch Guard Time
    /** Format `L` - Read-write
     */
    NET_KEY_SWITCH_GUARDTIME = 0x40 + 10,
     ...
     */
    NET_LEAVE_GRACEFULLY = 0x40 + 12,

    /// Thread Leader IPv6 Address
    /** Format `6` - Read only
     */
    THREAD_LEADER_ADDR = 0x50 + 0,
     ...
     */
    THREAD_LOCAL_LEADER_WEIGHT = 0x50 + 5,

    /// Thread Local Network Data
    /** Format `D` - Read only
     */
    THREAD_NETWORK_DATA = 0x50 + 6,

    /// Thread Local Network Data Version
    /** Format `C` - Read only
     */
    THREAD_NETWORK_DATA_VERSION = 0x50 + 7,

    /// Thread Local Stable Network Data
    /** Format `D` - Read only
     */
    THREAD_STABLE_NETWORK_DATA = 0x50 + 8,

    /// Thread Local Stable Network Data Version
    /** Format `C` - Read only
     */
    THREAD_STABLE_NETWORK_DATA_VERSION = 0x50 + 9,
     ...
     */
    THREAD_OFF_MESH_ROUTES = 0x50 + 11,
     ...
     */
    THREAD_ASSISTING_PORTS = 0x50 + 12,
     ...
     */
    THREAD_ALLOW_LOCAL_NET_DATA_CHANGE = 0x50 + 13,
     ...
     */
    THREAD_CHILD_TIMEOUT = 0x1500 + 0,

    /// Thread RLOC16
    /** Format: `S`
     */
    THREAD_RLOC16 = 0x1500 + 1,

    /// Thread Router Upgrade Threshold
    /** Format: `C`
     */
    THREAD_ROUTER_UPGRADE_THRESHOLD = 0x1500 + 2,

    /// Thread Context Reuse Delay
    /** Format: `L`
     */
    THREAD_CONTEXT_REUSE_DELAY = 0x1500 + 3,

    /// Thread Network ID Timeout
    /** Format: `C`
     */
    THREAD_NETWORK_ID_TIMEOUT = 0x1500 + 4,
     ...
     * a leader.
     */
    THREAD_ACTIVE_ROUTER_IDS = 0x1500 + 5,
     ...
     * Default is false.
     */
    THREAD_RLOC16_DEBUG_PASSTHRU = 0x1500 + 6,
     ...
     */
    THREAD_ROUTER_ROLE_ENABLED = 0x1500 + 7,

    /// Thread Router Downgrade Threshold
    /** Format: `C`
     */
    THREAD_ROUTER_DOWNGRADE_THRESHOLD = 0x1500 + 8,

    /// Thread Router Selection Jitter
    /** Format: `C`
     */
    THREAD_ROUTER_SELECTION_JITTER = 0x1500 + 9,
     ...
     * disabled.
     */
    THREAD_PREFERRED_ROUTER_ID = 0x1500 + 10,
     ...
     */
    THREAD_NEIGHBOR_TABLE = 0x1500 + 11,
     ...
     * has been stopped.
     */
    THREAD_CHILD_COUNT_MAX = 0x1500 + 12,

    /// Leader Network Data
    /** Format: `D` - Read only
     */
    THREAD_LEADER_NETWORK_DATA = 0x1500 + 13,

    /// Stable Leader Network Data
    /** Format: `D` - Read only
     */
    THREAD_STABLE_LEADER_NETWORK_DATA = 0x1500 + 14,
     ...
     */
    THREAD_COMMISSIONER_ENABLED = 0x1500 + 16,
     ...
     */
    THREAD_TMF_PROXY_ENABLED = 0x1500 + 17,
     ...
     */
    THREAD_TMF_PROXY_STREAM = 0x1500 + 18,
     ...
     * Default value is `false`.
     */
    THREAD_DISCOVERY_SCAN_JOINER_FLAG = 0x1500 + 19,
     ...
     * Default value is `false`
     */
    THREAD_DISCOVERY_SCAN_ENABLE_FILTERING = 0x1500 + 20,
     ...
     */
    THREAD_DISCOVERY_SCAN_PANID = 0x1500 + 21,
     ...
     *    data/bloom filter.
     */
    THREAD_STEERING_DATA = 0x1500 + 22,
     ...
     */
    THREAD_ACTIVE_DATASET = 0x1500 + 24,
     ...
     *   DATASET_DELAY_TIMER
     */
    THREAD_PENDING_DATASET = 0x1500 + 25,
     ...
     *    DATASET_RAW_TLVS
     */
    THREAD_MGMT_SET_ACTIVE_DATASET = 0x1500 + 26,
     ...
     *    DATASET_RAW_TLVS
     */
    THREAD_MGMT_SET_PENDING_DATASET = 0x1500 + 27,
     ...
     */
    DATASET_ACTIVE_TIMESTAMP = 0x1500 + 28,
     ...
     *   THREAD_MGMT_GET_PENDING_DATASET
     */
    DATASET_PENDING_TIMESTAMP = 0x1500 + 29,
     ...
     */
    DATASET_SECURITY_POLICY = 0x1500 + 31,
     ...
     */
    THREAD_CHILD_TABLE_ADDRESSES = 0x1500 + 33,
     ...
     *  `c`: Last RSSI (in dBm)
     */
    THREAD_NEIGHBOR_TABLE_ERROR_RATES = 0x1500 + 34,
     ...
     */
    THREAD_ADDRESS_CACHE_TABLE = 0x1500 + 35,
     ...
     *  `S`: Local UDP port
     */
    THREAD_UDP_FORWARD_STREAM = 0x1500 + 36,
     ...
     */
    THREAD_MGMT_GET_ACTIVE_DATASET = 0x1500 + 37,
     ...
     */
    THREAD_MGMT_GET_PENDING_DATASET = 0x1500 + 38,
     ...
     *   THREAD_MGMT_GET_PENDING_DATASET
     */
    DATASET_DEST_ADDRESS = 0x1500 + 39,
     ...
     *   +---------------+----+----------------+
     */
    THREAD_LINK_METRICS_QUERY_RESULT = 0x1500 + 46,
     ...
     */
    THREAD_LINK_METRICS_PROBE = 0x1500 + 47,
     ...
     *   +---------------+----+----------------+
     */
    THREAD_LINK_METRICS_MGMT_ENH_ACK_IE = 0x1500 + 49,
     ...
     * `C` : Received status
     */
    THREAD_LINK_METRICS_MGMT_RESPONSE = 0x1500 + 51,
     ...
     * `C`: Sequence Number.
     */
    THREAD_BACKBONE_ROUTER_PRIMARY = 0x1500 + 55,
     ...
     */
    THREAD_BACKBONE_ROUTER_LOCAL_STATE = 0x1500 + 56,
     ...
     * `C`: Sequence Number.
     */
    THREAD_BACKBONE_ROUTER_LOCAL_CONFIG = 0x1500 + 57,
     ...
     */
    THREAD_BACKBONE_ROUTER_LOCAL_REGISTER = 0x1500 + 58,
     ...
     */
    THREAD_BACKBONE_ROUTER_LOCAL_REGISTRATION_JITTER = 0x1500 + 59,
     ...
     */
    THREAD_ACTIVE_DATASET_TLVS = 0x1500 + 60,
     ...
     * On write, any unknown/unsupported TLVs must be ignored.
     */
    THREAD_PENDING_DATASET_TLVS = 0x1500 + 61,
     ...
     * On write, any unknown/unsupported TLVs must be ignored.
     */
    THREAD_MGMT_SET_PENDING_DATASET_TLVS = 0x1500 + 62,
     ...
     */
    THREAD_WAKEUP_CHANNEL = 0x1500 + 63,

    /// Link-Local IPv6 Address
    /** Format: `6` - Read only
     */
    IPV6_LL_ADDR = 0x60 + 0, ///< [6]
     ...
     *  `L`: Valid Lifetime
     */
    IPV6_ADDRESS_TABLE = 0x60 + 3,

    /// IPv6 Route Table - Deprecated
    IPV6_ROUTE_TABLE = 0x60 + 4,
     ...
     */
    IPV6_MULTICAST_ADDRESS_TABLE = 0x60 + 6,
     ...
     */
    IPV6_ICMP_PING_OFFLOAD_MODE = 0x60 + 7, ///< [b]
     ...
     */
    MESHCOP_JOINER_COMMISSIONING = 0x80 + 1,
     ...
     */
    MESHCOP_COMMISSIONER_STATE = 0x80 + 2,
     ...
     */
    MESHCOP_COMMISSIONER_JOINERS = 0x80 + 3,
     ...
     * Required capability: SPINEL_CAP_THREAD_COMMISSIONER
     */
    MESHCOP_COMMISSIONER_PROVISIONING_URL = 0x80 + 4,
     ...
     * Required capability: SPINEL_CAP_THREAD_COMMISSIONER
     */
    MESHCOP_COMMISSIONER_SESSION_ID = 0x80 + 5,
     ...
     * no value field).
     */
    MESHCOP_JOINER_DISCERNER = 0x80 + 6,
     ...
     *   `6` : IPv6 destination
     */
    MESHCOP_COMMISSIONER_ANNOUNCE_BEGIN = 0x1800 + 0,
     ...
     *   `6` : IPv6 destination.
     */
    MESHCOP_COMMISSIONER_ENERGY_SCAN = 0x1800 + 1,
     ...
     */
    MESHCOP_COMMISSIONER_ENERGY_SCAN_RESULT = 0x1800 + 2,
     ...
     *   `6` : IPv6 destination
     */
    MESHCOP_COMMISSIONER_PAN_ID_QUERY = 0x1800 + 3,
     ...
     *   `L` : Channel mask
     */
    MESHCOP_COMMISSIONER_PAN_ID_CONFLICT_RESULT = 0x1800 + 4,
     ...
     */
    MESHCOP_COMMISSIONER_MGMT_GET = 0x1800 + 5,
     ...
     *   `d` : TLV encoded data
     */
    MESHCOP_COMMISSIONER_MGMT_SET = 0x1800 + 6,
     ...
     */
    MESHCOP_COMMISSIONER_GENERATE_PSKC = 0x1800 + 7,
     ...
     */
    CHANNEL_MANAGER_NEW_CHANNEL = 0x1900 + 0,
     ...
     * network.
     */
    CHANNEL_MANAGER_DELAY = 0x1900 + 1,
     ...
     */
    CHANNEL_MANAGER_SUPPORTED_CHANNELS = 0x1900 + 2,
     ...
     */
    CHANNEL_MANAGER_FAVORED_CHANNELS = 0x1900 + 3,
     ...
     */
    CHANNEL_MANAGER_CHANNEL_SELECT = 0x1900 + 4,
     ...
     */
    CHANNEL_MANAGER_AUTO_SELECT_ENABLED = 0x1900 + 5,
     ...
     */
    CHANNEL_MANAGER_AUTO_SELECT_INTERVAL = 0x1900 + 6,
     ...
     */
    TIME_SYNC_XTAL_THRESHOLD = 0x1900 + 9,
     ...
     */
    CHILD_SUPERVISION_INTERVAL = 0x1900 + 10,
     ...
     */
    CHILD_SUPERVISION_CHECK_TIMEOUT = 0x1900 + 11,
     ...
     * This property is available for FTD build only.
     */
    PARENT_RESPONSE_INFO = 0x1900 + 13,
     ...
     */
    SUPPORTED_RADIO_LINKS = 0x1900 + 15,
     ...
     */
    NEIGHBOR_TABLE_MULTI_RADIO_INFO = 0x1900 + 16,
     ...
     */
    SRP_CLIENT_LEASE_INTERVAL = 0x1900 + 18,
     ...
     */
    SRP_CLIENT_KEY_LEASE_INTERVAL = 0x1900 + 19,
     ...
     */
    SRP_CLIENT_HOST_INFO = 0x1900 + 20,

    /// SRP Client Host Name (label).
    /** Format: `U` - Read/Write
     * Required capability: `SPINEL_CAP_SRP_CLIENT`.
     */
    SRP_CLIENT_HOST_NAME = 0x1900 + 21,

    /// SRP Client Host Addresses
    /** Format: `A(6)` - Read/Write
     * Required capability: `SPINEL_CAP_SRP_CLIENT`.
     */
    SRP_CLIENT_HOST_ADDRESSES = 0x1900 + 22,
     ...
     */
    SRP_CLIENT_HOST_SERVICES_REMOVE = 0x1900 + 24,
     ...
     */
    SRP_CLIENT_HOST_SERVICES_CLEAR = 0x1900 + 25,
     ...
     */
    SRP_CLIENT_SERVICE_KEY_ENABLED = 0x1900 + 27,
     ...
     * This allows changes to be aggregated into a single event.
     */
    SERVER_ALLOW_LOCAL_DATA_CHANGE = 0xa0 + 0,
     ...
     * Please see "Spinel definition compatibility guideline" section.
     */
    RCP_MIN_HOST_API_VERSION = 0xb0 + 1,
    ...
    IEEE_802_15_4_PIB_PHY_CHANNELS_SUPPORTED = 0x400 + 0x01, ///< [A(L)]
    IEEE_802_15_4_PIB_MAC_PROMISCUOUS_MODE = 0x400 + 0x51, ///< [b]
    IEEE_802_15_4_PIB_MAC_SECURITY_ENABLED = 0x400 + 0x5d, ///< [b]
     ...
     */
    CNTR_ALL_MAC_COUNTERS = 0x500 + 401,
     ...
     */
    CNTR_ALL_IP_COUNTERS = 0x500 + 403,
     ...
     */
    CNTR_MAC_RETRY_HISTOGRAM = 0x500 + 404,
     ...
     * Default value: 0
     */
    MULTIPAN_ACTIVE_INTERFACE = 0x900 + 0,
     ...
     */
    SRP_SERVER_AUTO_ENABLE_MODE = 0x920 + 2,
     ...
     */
    DNSSD_KEY_RECORD = 0x930 + 5,

    NEST_STREAM_MFG = 0x3bc0 + 0,
     ...
     * This property is deprecated.
     */
    NEST_LEGACY_ULA_PREFIX = 0x3bc0 + 1,
     ...
     * This property is deprecated.
     */
    NEST_LEGACY_LAST_NODE_JOINED = 0x3bc0 + 2,
     ...
     */
    DEBUG_TEST_ASSERT = 0x4000 + 0,

    /// The NCP log level.
    /** Format: `C` */
    DEBUG_NCP_LOG_LEVEL = 0x4000 + 1,
     ...
     */
    DEBUG_LOG_TIMESTAMP_BASE = 0x4000 + 3,
     ...
     */
    DEBUG_TREL_TEST_MODE_ENABLE = 0x4000 + 4,
}
